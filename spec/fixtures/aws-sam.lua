...
function _M.start_local_lambda()
  ...
  local ret, err = utils.wait_output("sam local start-lambda --template-file=spec/fixtures/sam-app/template.yaml --port " .. port, "Starting the Local Lambda Service", 30)
  if err then
